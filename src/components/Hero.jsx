...
const Hero = () => {
  ...
  return (
    <section className="h-[90vh] bg-[#353535] flex flex-col justify-center items-center gap-6 p-3 md:p-4">
      <h2 className="font-neueHaas font-bold text-[#A3BE8C] text-4xl text-center tracking-wide leading-tight md:text-7xl md:leading-snug lg:leading-[1.2] lg:text-8xl lg:w-2/4 animate-fadeIn">
      ...
      <div className="button-container animate-bounce">
        ...
        >
          Visit My <i className="fa-brands fa-github"></i>
        </button>
      </div>
    </section>
  );
